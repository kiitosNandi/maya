          ...
          <div className="row">
            <div className="col-xl-4 col-md-6">
              <div className="contact-info-item wow fadeInUp delay-0-4s">
                ...
                <div className="content">
                  <h4>Location</h4>
                  <span>57 Accra Digital center, Accra Ghana</span>
                </div>
              </div>
            </div>
            <div className="col-xl-4 col-md-6">
              <div className="contact-info-item wow fadeInUp delay-0-5s">
                ...
                <div className="content">
                  <h4>Email Us</h4>
                  <a href="mailto:organicfarm@mail.net">mayatek.gh@gmail.com</a>
                  <br />
                  <a href="mailto:support@info.com">mayatek.gh@gmail.com</a>
                  <br />
                </div>
              </div>
            </div>
            <div className="col-xl-4 col-md-6">
              <div className="contact-info-item wow fadeInUp delay-0-6s">
                ...
                <div className="content">
                  <h4>Phone Us</h4>
                  <a href="callto:+000(111)345678">+233 24579 2200</a>
                  <br />
                  <a href="callto:+012(345)67899">+233 24579 2200</a>
                </div>
              </div>
            </div>
          </div>
